...
export function Footer() {
  return (
    <footer className="border-t border-[rgba(245,166,35,0.15)] bg-cream px-4 pb-6 pt-14 sm:px-8 max-lg:pt-12 lg:px-16">
      <div className="mb-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-[180px_1fr_1fr_1fr_1fr] lg:gap-10">
        <div>
      ...
      <div className="flex flex-col gap-2 border-t border-[rgba(0,0,0,0.08)] pt-5 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
